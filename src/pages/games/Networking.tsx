...
const questions: Question[] = [
  {
    id: 1,
    question: "Яка маска підмережі відповідає /24 у CIDR?",
    options: ["255.255.0.0", "255.255.255.0", "255.255.255.255", "255.0.0.0"],
    correctAnswer: 1,
    category: "IP адресація",
    explanation: "/24 означає 24 біти для мережі = 255.255.255.0"
  },
  {
    id: 2,
    question: "Який протокол для автоматичного отримання IP?",
    options: ["DNS", "DHCP", "ARP", "ICMP"],
    correctAnswer: 1,
    category: "Протоколи",
    explanation: "DHCP автоматично призначає IP-адреси"
  },
  {
    id: 3,
    question: "Скільки адрес можна використати в /30?",
    options: ["2", "4", "6", "8"],
    correctAnswer: 0,
    category: "Підмережі",
    explanation: "/30 дає 4 адреси, але 2 зарезервовані"
  },
  {
    id: 4,
    question: "Який порт використовує HTTPS?",
    options: ["80", "443", "8080", "22"],
    correctAnswer: 1,
    category: "Порти",
    explanation: "HTTPS використовує порт 443"
  },
  {
    id: 5,
    question: "Що означає TTL у пакеті?",
    options: ["Total Transfer Length", "Time To Live", "Transfer Time Limit", "Type Level"],
    correctAnswer: 1,
    category: "TCP/IP",
    explanation: "TTL визначає максимум переходів між роутерами"
  },
  {
    id: 6,
    question: "Який протокол на рівні 3 OSI?",
    options: ["TCP", "HTTP", "IP", "Ethernet"],
    correctAnswer: 2,
    category: "OSI Model",
    explanation: "IP працює на мережевому рівні (Layer 3)"
  },
  {
    id: 7,
    question: "Що робить команда ping?",
    options: [
      "Перевіряє доступність через ICMP",
    ...
    explanation: "ping використовує ICMP для перевірки доступності"
  }
];
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      >
                        ...
                        {showCorrectness && isSelected && !isCorrect && <X className="h-4 w-4 text-white" />}
